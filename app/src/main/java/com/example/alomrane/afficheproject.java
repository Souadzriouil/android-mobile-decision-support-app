...
public class afficheproject extends AppCompatActivity {
    ...
    private static final String TAG = "afficheproject";

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_afficheproject);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                String prixtText =  String.valueOf(prix) +".0DH";
                        ...
                        db.collection("AI")
                                ...
                                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                                    ...
                                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                                        ...
                                        if (value != null) {
                                            for (QueryDocumentSnapshot document : value) {
                                               // Récupérer les données de AI
                                                String des = document.getString("description");

                                                String idappartement = document.getString("appartement_id");
                                                // Afficher les données de Spinbou
                                                StringBuilder builde= new StringBuilder(descriptionEditText.getText());
                                                builde.append("Les avantages et les inconvénients de l'appartement et de ses chambres : ").append(des).append("\n");
                                                descriptionEditText.setText(builde);
                                            }
                                        }
                                    }
